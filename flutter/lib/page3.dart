...
class _Page3State extends State<Page3> {
  ...
  updateData() async {
    var url = Uri.parse(
        'https://gsx2json.com/api?id=148r8M7CVsmZuGy7VsPWBGoeT3hlCprBk8xCd0vTF_rs&sheet=oda_3_sicaklik&api_key=');
  ...
  turnOnLight() async {
    ...
    var url = Uri.parse(
        'https://script.google.com/macros/s/AKfycbzetm_JaZh6_-MEuyL0mlgjX7md-wnVy6en95OvTk3dOyYLhmXVAeaSqVVO0H7_b4k1/exec?isik3_durum=1');
    http.Response response = await http.get(url);
    try {
      if (response.statusCode == 200) {
        String data = response.body;
  ...
  turnOffLight() async {
    ...
    var url = Uri.parse(
        'https://script.google.com/macros/s/AKfycbzetm_JaZh6_-MEuyL0mlgjX7md-wnVy6en95OvTk3dOyYLhmXVAeaSqVVO0H7_b4k1/exec?isik3_durum=0');
    http.Response response = await http.get(url);
    try {
      if (response.statusCode == 200) {
        return 'okey';
