...
void loop() 
{
  ...
  String url = "/api?id=148r8M7CVsmZuGy7VsPWBGoeT3hlCprBk8xCd0vTF_rs&sheet=oda_3_isik&api_key=";
  String payload = "";
  ...
  JsonArray& rowsArray = root["columns"]["isik3_durum"];
  int rows_array_size = rowsArray.size();
  Serial.println(F("Response:"));
  String isik_durum = root["columns"]["isik3_durum"][rows_array_size-1].as<String>();
