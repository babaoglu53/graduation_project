...
void loop() 
{
  ...
  String url = "/api?id=148r8M7CVsmZuGy7VsPWBGoeT3hlCprBk8xCd0vTF_rs&sheet=salon_isik&api_key=";
  String payload = "";
  ...
  JsonArray& rowsArray = root["columns"]["salon_isik_durum"];
  int rows_array_size = rowsArray.size();
  Serial.println(F("Response:"));
  String isik_durum = root["columns"]["salon_isik_durum"][rows_array_size-1].as<String>();
...
{ 
  ...
  url += "sicaklik4=" + String(t);
  url += "&";
  url += "nem_salon=" + String(h);
